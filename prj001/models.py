...
class Other(models.Model):
    ...
    #
    born_zaochan = models.BooleanField(verbose_name="早产", default=False)
    born_zuyuechan = models.BooleanField(verbose_name="足月产", default=False)
    born_yindaofenmian = models.BooleanField(verbose_name="阴道分娩", default=False)
    born_pougongchan = models.BooleanField(verbose_name="剖宫产", default=False)
    ...
    pastpreg_yuncount = models.CharField(verbose_name=u'孕次总数', max_length=20)
    pastpreg_pougong = models.CharField(verbose_name=u'剖宫产次数', blank=True, null=True, max_length=10)
    pastpreg_shunchan = models.CharField(verbose_name=u'顺产次数', blank=True, null=True, max_length=10)
    pastpreg_yaoliu = models.CharField(verbose_name=u'药物流产次数', blank=True, null=True, max_length=10)
    pastpreg_renliu = models.CharField(verbose_name=u'人工流产次数', blank=True, null=True, max_length=10)
    ...
    accessory_quanxuexibaojishu = models.CharField(verbose_name=u'全血细胞计数', max_length=500, blank=True, null=True)
